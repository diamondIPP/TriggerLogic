...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BEAM_CURRENT_IN [ create_bd_port -dir I -from 1 -to 0 BEAM_CURRENT_IN ]
  set BUSY_IN [ create_bd_port -dir I -from 3 -to 0 BUSY_IN ]
  set CAEN_DIG [ create_bd_port -dir O -from 1 -to 0 CAEN_DIG ]
  set CLK_0 [ create_bd_port -dir O CLK_0 ]
  set CLK_1 [ create_bd_port -dir O CLK_1 ]
  set CLK_2 [ create_bd_port -dir O CLK_2 ]
  set DIAMOND_TRIG_IN [ create_bd_port -dir I -from 1 -to 0 DIAMOND_TRIG_IN ]
  set DRS4_CH3 [ create_bd_port -dir O -from 1 -to 0 DRS4_CH3 ]
  set DRS4_TRIG_IN_CH2 [ create_bd_port -dir O -from 1 -to 0 DRS4_TRIG_IN_CH2 ]
  set FASTOR_TRIG_IN [ create_bd_port -dir I -from 15 -to 0 FASTOR_TRIG_IN ]
  set LOGIC_DRS4_CH4 [ create_bd_port -dir O -from 1 -to 0 LOGIC_DRS4_CH4 ]
  set LOGIC_PREAMP_TP_SEL [ create_bd_port -dir O -from 1 -to 0 LOGIC_PREAMP_TP_SEL ]
  set PSI46_ATB_DTB [ create_bd_port -dir O -from 1 -to 0 PSI46_ATB_DTB ]
  set PULSER_DRS4_CH4 [ create_bd_port -dir O -from 1 -to 0 PULSER_DRS4_CH4 ]
  set PULSER_PREAMP_TP_SEL [ create_bd_port -dir O -from 1 -to 0 PULSER_PREAMP_TP_SEL ]
  set PULSER_PREAMP_TP_TTL [ create_bd_port -dir O -from 1 -to 0 PULSER_PREAMP_TP_TTL ]
  set SCINTILLATOR_TRIG_IN [ create_bd_port -dir I -from 1 -to 0 SCINTILLATOR_TRIG_IN ]
  set TRIG_1 [ create_bd_port -dir O TRIG_1 ]
  set TRIG_2 [ create_bd_port -dir O TRIG_2 ]
  set TRIG_3 [ create_bd_port -dir O TRIG_3 ]
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {rgmii} CONFIG.MDIO_BOARD_INTERFACE {mdio_mdc} CONFIG.PHYRST_BOARD_INTERFACE {phy_reset_out} CONFIG.RXCSUM {Full} CONFIG.RXMEM {32k} CONFIG.TXCSUM {Full} CONFIG.TXMEM {32k} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_0
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_ALL_OUTPUTS_2 {1} CONFIG.C_GPIO2_WIDTH {7} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_IS_DUAL {1} CONFIG.GPIO2_BOARD_INTERFACE {LCD_7Bits} CONFIG.GPIO_BOARD_INTERFACE {LED_4Bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0

  # Create instance: axi_mem_intercon, and set properties
  set axi_mem_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon ]
  set_property -dict [ list CONFIG.NUM_MI {2} CONFIG.NUM_SI {5} CONFIG.STRATEGY {2}  ] $axi_mem_intercon

  # Create instance: axi_quad_spi_0, and set properties
  set axi_quad_spi_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 axi_quad_spi_0 ]
  set_property -dict [ list CONFIG.C_SCK_RATIO {2} CONFIG.C_SPI_MEMORY {2} CONFIG.C_SPI_MODE {2} CONFIG.C_TYPE_OF_AXI4_INTERFACE {0} CONFIG.C_USE_STARTUP {1} CONFIG.C_XIP_MODE {0} CONFIG.QSPI_BOARD_INTERFACE {spi_flash} CONFIG.USE_BOARD_FLOW {true}  ] $axi_quad_spi_0
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {172.571} CONFIG.CLKOUT1_PHASE_ERROR {221.516} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.000} CONFIG.CLKOUT2_JITTER {146.665} CONFIG.CLKOUT2_PHASE_ERROR {221.516} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {400} CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_JITTER {263.745} CONFIG.CLKOUT3_PHASE_ERROR {221.516} CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {10} CONFIG.CLKOUT3_USED {false} CONFIG.MMCM_CLKFBOUT_MULT_F {48.125} CONFIG.MMCM_CLKOUT0_DIVIDE_F {9.625} CONFIG.MMCM_CLKOUT1_DIVIDE {3} CONFIG.MMCM_CLKOUT2_DIVIDE {1} CONFIG.MMCM_DIVCLK_DIVIDE {4} CONFIG.NUM_OUT_CLKS {2}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.C_CACHE_BYTE_SIZE {65536} \
CONFIG.C_DCACHE_ALWAYS_USED {1} CONFIG.C_DCACHE_BASEADDR {0x80000000} \
CONFIG.C_DCACHE_BYTE_SIZE {65536} CONFIG.C_DCACHE_HIGHADDR {0xBFFFFFFF} \
CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DCACHE_USE_WRITEBACK {1} \
CONFIG.C_DCACHE_VICTIMS {0} CONFIG.C_DEBUG_ENABLED {1} \
CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} \
CONFIG.C_FREQ {100000000} CONFIG.C_ICACHE_ALWAYS_USED {1} \
CONFIG.C_ICACHE_BASEADDR {0x80000000} CONFIG.C_ICACHE_HIGHADDR {0xBFFFFFFF} \
CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ICACHE_STREAMS {0} \
CONFIG.C_ICACHE_VICTIMS {0} CONFIG.C_I_LMB {1} \
CONFIG.C_M_AXI_DC_USER_SIGNALS {0} CONFIG.C_M_AXI_IC_USER_SIGNALS {0} \
CONFIG.C_USE_BARREL {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {1} \
CONFIG.C_USE_DCACHE {1} CONFIG.C_USE_DIV {1} \
CONFIG.C_USE_EXT_BRK {0} CONFIG.C_USE_EXT_NM_BRK {0} \
CONFIG.C_USE_FPU {2} CONFIG.C_USE_HW_MUL {2} \
CONFIG.C_USE_ICACHE {1} CONFIG.C_USE_INTERRUPT {2} \
CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} \
CONFIG.G_TEMPLATE_LIST {2}  ] $microblaze_0
  ...
  # Create instance: phase_shift_40MHz_clk_gen_axi_0, and set properties
  set phase_shift_40MHz_clk_gen_axi_0 [ create_bd_cell -type ip -vlnv user.org:user:phase_shift_40MHz_clk_gen_axi:1.0 phase_shift_40MHz_clk_gen_axi_0 ]

  # Create instance: proc_sys_reset_1, and set properties
  set proc_sys_reset_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_1 ]
  set_property -dict [ list CONFIG.C_AUX_RESET_HIGH {0}  ] $proc_sys_reset_1

  # Create instance: real_time_clock_v1_0_S00_AXI_0, and set properties
  set real_time_clock_v1_0_S00_AXI_0 [ create_bd_cell -type ip -vlnv user.org:user:real_time_clock_v1_0_S00_AXI:1.0 real_time_clock_v1_0_S00_AXI_0 ]
  ...
  set_property -dict [ list CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.USE_BOARD_FLOW {true}  ] $rst_clk_wiz_0_125M

  # Create instance: rst_clk_wiz_0_401M, and set properties
  set rst_clk_wiz_0_401M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_0_401M ]
  set_property -dict [ list CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.USE_BOARD_FLOW {true}  ] $rst_clk_wiz_0_401M

  # Create instance: trigger_logic_AXI_0, and set properties
  set trigger_logic_AXI_0 [ create_bd_cell -type ip -vlnv user.org:user:trigger_logic_AXI:1.1 trigger_logic_AXI_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins trigger_logic_AXI_0/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins real_time_clock_v1_0_S00_AXI_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI] [get_bd_intf_pins phase_shift_40MHz_clk_gen_axi_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net BEAM_CURRENT_IN_1 [get_bd_ports BEAM_CURRENT_IN] [get_bd_pins trigger_logic_AXI_0/BEAM_CURRENT_IN]
  connect_bd_net -net BUSY_IN_1 [get_bd_ports BUSY_IN] [get_bd_pins trigger_logic_AXI_0/BUSY_IN]
  connect_bd_net -net DIAMOND_TRIG_IN_1 [get_bd_ports DIAMOND_TRIG_IN] [get_bd_pins trigger_logic_AXI_0/DIAMOND_TRIG_IN]
  connect_bd_net -net FASTOR_TRIG_IN_1 [get_bd_ports FASTOR_TRIG_IN] [get_bd_pins trigger_logic_AXI_0/FASTOR_TRIG_IN]
  connect_bd_net -net SCINTILLATOR_TRIG_IN_1 [get_bd_ports SCINTILLATOR_TRIG_IN] [get_bd_pins trigger_logic_AXI_0/SCINTILLATOR_TRIG_IN]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins real_time_clock_v1_0_S00_AXI_0/S_AXI_ACLK] [get_bd_pins rst_clk_wiz_0_125M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins phase_shift_40MHz_clk_gen_axi_0/S_AXI_ACLK] [get_bd_pins rst_clk_wiz_0_401M/slowest_sync_clk] [get_bd_pins trigger_logic_AXI_0/S_AXI_ACLK]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_125M/dcm_locked] [get_bd_pins rst_clk_wiz_0_401M/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_1/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_0_dma/m_axi_mm2s_aclk] [get_bd_pins axi_ethernet_0_dma/m_axi_s2mm_aclk] [get_bd_pins axi_ethernet_0_dma/m_axi_sg_aclk] [get_bd_pins axi_ethernet_0_dma/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net phase_shift_40MHz_clk_gen_axi_0_CLK_0 [get_bd_ports CLK_0] [get_bd_pins phase_shift_40MHz_clk_gen_axi_0/CLK_0]
  connect_bd_net -net phase_shift_40MHz_clk_gen_axi_0_CLK_1 [get_bd_ports CLK_1] [get_bd_pins phase_shift_40MHz_clk_gen_axi_0/CLK_1]
  connect_bd_net -net phase_shift_40MHz_clk_gen_axi_0_CLK_2 [get_bd_ports CLK_2] [get_bd_pins phase_shift_40MHz_clk_gen_axi_0/CLK_2]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_0_dma/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_125M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_401M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_125M_peripheral_aresetn [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins real_time_clock_v1_0_S00_AXI_0/S_AXI_ARESETN] [get_bd_pins rst_clk_wiz_0_125M/peripheral_aresetn]
  connect_bd_net -net rst_clk_wiz_0_401M_peripheral_aresetn [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins phase_shift_40MHz_clk_gen_axi_0/S_AXI_ARESETN] [get_bd_pins rst_clk_wiz_0_401M/peripheral_aresetn] [get_bd_pins trigger_logic_AXI_0/S_AXI_ARESETN]
  ...
  connect_bd_net -net trigger_logic_AXI_0_CAEN_DIG [get_bd_ports CAEN_DIG] [get_bd_pins trigger_logic_AXI_0/CAEN_DIG]
  connect_bd_net -net trigger_logic_AXI_0_DRS4_CH3 [get_bd_ports DRS4_CH3] [get_bd_pins trigger_logic_AXI_0/DRS4_CH3]
  connect_bd_net -net trigger_logic_AXI_0_DRS4_TRIG_IN_CH2 [get_bd_ports DRS4_TRIG_IN_CH2] [get_bd_pins trigger_logic_AXI_0/DRS4_TRIG_IN_CH2]
  connect_bd_net -net trigger_logic_AXI_0_LOGIC_DRS4_CH4 [get_bd_ports LOGIC_DRS4_CH4] [get_bd_pins trigger_logic_AXI_0/LOGIC_DRS4_CH4]
  connect_bd_net -net trigger_logic_AXI_0_LOGIC_PREAMP_TP_SEL [get_bd_ports LOGIC_PREAMP_TP_SEL] [get_bd_pins trigger_logic_AXI_0/LOGIC_PREAMP_TP_SEL]
  connect_bd_net -net trigger_logic_AXI_0_PSI46_ATB_DTB [get_bd_ports PSI46_ATB_DTB] [get_bd_pins trigger_logic_AXI_0/PSI46_ATB_DTB]
  connect_bd_net -net trigger_logic_AXI_0_PULSER_DRS4_CH4 [get_bd_ports PULSER_DRS4_CH4] [get_bd_pins trigger_logic_AXI_0/PULSER_DRS4_CH4]
  connect_bd_net -net trigger_logic_AXI_0_PULSER_PREAMP_TP_SEL [get_bd_ports PULSER_PREAMP_TP_SEL] [get_bd_pins trigger_logic_AXI_0/PULSER_PREAMP_TP_SEL]
  connect_bd_net -net trigger_logic_AXI_0_PULSER_PREAMP_TP_TTL [get_bd_ports PULSER_PREAMP_TP_TTL] [get_bd_pins trigger_logic_AXI_0/PULSER_PREAMP_TP_TTL]
  connect_bd_net -net trigger_logic_AXI_0_TRIG_1 [get_bd_ports TRIG_1] [get_bd_pins trigger_logic_AXI_0/TRIG_1]
  connect_bd_net -net trigger_logic_AXI_0_TRIG_2 [get_bd_ports TRIG_2] [get_bd_pins trigger_logic_AXI_0/TRIG_2]
  connect_bd_net -net trigger_logic_AXI_0_TRIG_3 [get_bd_ports TRIG_3] [get_bd_pins trigger_logic_AXI_0/TRIG_3]

  # Create address segments
  create_bd_addr_seg -range 0x1000 -offset 0xC0000000 [get_bd_addr_spaces axi_ethernet_0_dma/Data_SG] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x1000 -offset 0xC0000000 [get_bd_addr_spaces axi_ethernet_0_dma/Data_MM2S] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x1000 -offset 0xC0000000 [get_bd_addr_spaces axi_ethernet_0_dma/Data_S2MM] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs phase_shift_40MHz_clk_gen_axi_0/S_AXI/reg0] SEG_phase_shift_40MHz_clk_gen_axi_0_reg0
  create_bd_addr_seg -range 0x10000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs real_time_clock_v1_0_S00_AXI_0/S_AXI/reg0] SEG_real_time_clock_v1_0_S00_AXI_0_reg0
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs trigger_logic_AXI_0/S_AXI/reg0] SEG_trigger_logic_AXI_0_reg0
