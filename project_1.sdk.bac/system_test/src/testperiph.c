...
int main() 
{
...

   {
      ...
      print("\r\n Running AxiDMASelfTestExample() for axi_ethernet_0_dma...\r\n");

      status = AxiDMASelfTestExample(XPAR_AXI_ETHERNET_0_DMA_DEVICE_ID);
...

   {
      ...
      Status = AxiEthernetSgDmaIntrExample(&intc, &axi_ethernet_0_eth_buf_AxiEthernet,
                     ...
                     XPAR_MICROBLAZE_0_AXI_INTC_AXI_ETHERNET_0_ETH_BUF_INTERRUPT_INTR,
