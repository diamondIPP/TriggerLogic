...
#endif
#else
#define PLATFORM_EMAC_BASEADDRSoftware Applications
XAPP1026 (v5.1) November 21, 2014
www.xilinx.com
 9
TCP RX Throughput Test and TCP TX Throughput Test
The TCP transmit and receive throughput test ap
plications are very simple applications that
determine the maximum TCP transmit a XPAR_XEMACPS_1_BASEADDR
#endif
#endif
#endif
